...
CLF_LINE = '192.168.1.10 - - [12/May/2026:10:23:01 +0000] "GET /index.html HTTP/1.1" 200 1234'
...
class TestSuspiciousPatterns:
    ...
    def test_detects_known_scanner_user_agents(self, user_agent):
        line = f'1.2.3.4 - - [12/May/2026:10:00:00 +0000] "GET / HTTP/1.1" 200 0 "-" "{user_agent}"'
