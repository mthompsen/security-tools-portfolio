...
COMMON_SERVICES: dict[int, str] = {
    ...
    464: 'Kerberos-pw', 465: 'SMTPS', 514: 'syslog', 515: 'LPD',
    587: 'SMTP-submission', 631: 'IPP', 636: 'LDAPS', 873: 'rsync',
    989: 'FTPS-data', 990: 'FTPS', 993: 'IMAPS', 995: 'POP3S',
    1080: 'SOCKS', 1194: 'OpenVPN', 1433: 'MSSQL', 1521: 'Oracle',
    1701: 'L2TP', 1723: 'PPTP', 2049: 'NFS', 2082: 'cPanel',
    2083: 'cPanel-SSL', 2222: 'SSH-alt', 2375: 'Docker', 2376: 'Docker-TLS',
    3000: 'Node-dev', 3128: 'Squid', 3306: 'MySQL', 3389: 'RDP',
    3690: 'SVN', 4444: 'Metasploit-default', 5000: 'UPnP/Flask-dev',
    ...
    7000: 'Cassandra', 7001: 'WebLogic', 8000: 'HTTP-alt',
    8008: 'HTTP-alt', 8080: 'HTTP-proxy', 8081: 'HTTP-alt',
    8086: 'InfluxDB', 8088: 'HTTP-alt', 8443: 'HTTPS-alt',
    8888: 'HTTP-alt', 9000: 'PHP-FPM/Jenkins', 9042: 'Cassandra-CQL',
...
async def scan_host(
    ...
    tasks = [
        scan_port(host, port, timeout, sem, banner_grab) for port in ports
    ]
...
def main() -> int:
    ...
    print(f'Scanning {args.target} ({resolved}) — {len(ports)} ports, '
