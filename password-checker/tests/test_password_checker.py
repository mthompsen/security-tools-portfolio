...
class TestCharacterClasses:
    def test_lowercase_only(self):
        size, has_lower, has_upper, has_digit, has_symbol = password_checker.character_classes(
            "abcdef"
        )
    ...
    def test_digits_only(self):
        size, has_lower, _has_upper, has_digit, _has_symbol = password_checker.character_classes(
            "12345"
        )
        assert has_digit is True
...
class TestHIBPCheck:
    def test_known_pwned_password_returns_count(self):
        ...
        """
        fake_response_body = "1E4C9B93F3F0682250B6CF8331B7EE68FD8:9999999\nOTHERHASHHASH:42\n"
